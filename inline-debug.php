<?php
/**
 * Inline Debug Tool for AI SEO Optimizer
 * 
 * Add this code to any WordPress page to debug AJAX issues
 * You can add this to your theme's functions.php temporarily
 */
